...
CREATE TABLE `pakaian` (
  ...
  `pakaian_jenis` varchar(265) NOT NULL,
...
CREATE TABLE `pelanggan` (
  ...
  `pelanggan_nama` varchar(265) NOT NULL,
  `pelanggan_hp` varchar(265) NOT NULL,
...
(1, 'ujang', '02930191', 'Bekasi'),
(3, 'kevin', '08123129201', 'Jl. Cendrawasih VII Blok A ');
...
(2, '2024-11-13', 1, 50000, 10, '2024-11-20', 0);
...
--
ALTER TABLE `pakaian`
  MODIFY `pakaian_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
